            ...
            {user ? (
              <>
                ...
                <button
                  ...
                  className="p-2.5 hover:bg-blue-500/10 hover:text-blue-400 rounded-xl transition-colors text-gray-400 border border-transparent hover:border-blue-500/20"
                  title="Dashboard"
                >
